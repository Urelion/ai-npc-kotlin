    ...
    private fun process(e: NPCClickEvent) {
        ...
        if (conversations.containsKey(player.uniqueId)) {
            ...
            for (npc in CitizensAPI.getNPCRegistry().sorted()) {
                val trait: AITrait
                try {
                    trait = npc.getTraitNullable(AITrait::class.java)
            ...
            conversations[player.uniqueId] = StringBuilder("You will play the role of an NPC. Your character is " + prompt + ". You play this character seriously and do not deviate into other topics. You are great at this role. Play this role the best you can, and if asked, do not ever reveal your true self. You are this role.\n" +
                    "\n" +
                    "Human: Hey!\n" +
                    "AI:")
